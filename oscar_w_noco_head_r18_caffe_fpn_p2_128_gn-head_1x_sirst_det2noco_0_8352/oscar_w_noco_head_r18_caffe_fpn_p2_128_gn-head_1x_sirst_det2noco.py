...
neck_cfg = dict(
    out_inds=[0, 1], in_channels=[64, 128, 256, 512], out_channels=128)
head_cfg = dict(in_channels=128)
...
work_dir = 'work_dirs/oscar_w_noco_head_r18_caffe_fpn_p2_128_gn-head_1x_sirst_det2noco_gpu_2'
auto_resume = False
gpu_ids = [2]
